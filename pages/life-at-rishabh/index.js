...
import MethodologyTabs from "@/components/Engage/MethodologyTabs";
import BenefitsGrid from "@/components/Engage/BenefitsGrid";
import TouchPoint from "@/components/Engage/TouchPoint";
import InnovationAndGrowth from "@/components/Partners/InnovationAndGrowth";
import Boost from "@/components/Partners/Boost";
import PartnerSection from "@/components/Partners/PartnerSection";
import FacilitySection from "@/components/LifeAtRishabh/FacilitySection";
import Testimonials from "@/components/LifeAtRishabh/Testimonials";
import PhotoGallery from "@/components/LifeAtRishabh/PhotoGallery";
import Together from "@/components/LifeAtRishabh/Together";
...
export default function LifeAtRishabh() {
