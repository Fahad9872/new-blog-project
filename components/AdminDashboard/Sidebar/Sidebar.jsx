...
import fulllogo from "../../../assets/Pages/Home/images/logo.png";
      ...
      >
        <div>
          ...
          >
            ...
            />
            <img
              className="group-hover:block w-[50px] h-[50px] hidden mx-3 "
              src={fulllogo.src}
              alt=""
            />
          </div>
          ...
          <div className="px-3  justify-start mt-10">
            ...
            >
              ...
              >
                ...
                <img
                  ...
                  alt=""
                />
                <p className={`group-hover:block hidden `}>Writing Task</p>
              </div>
            </Link>
            {/* <Link
              legacyBehavior
            ...
            <Link
              legacyBehavior
              prefetch={false}
              href="/admin-dashboard/success-story"
              activeClassName="active"
            >
              <div
                className={`${
                  router.asPath.includes("success-story")
                    ? "bg-[#F4EBFF] shadow-left-purple text-[#7D23E0] font-semibold"
                    : "text-[#7D7D7D] font-medium"
                } hover:bg-[#F4EBFF]  text-[14px] group/item hover:shadow-left-purple hover:text-[#7D23E0] hover:font-semibold  rounded-[10px] w-full  p-2 w-fit cursor-pointer my-1 flex items-center gap-2`}
              >
                ...
                <img
                  ...
                  className={`w-[24px] h-[24px] group-hover/item:block ${
                    router.asPath.includes("success-story") ? "block" : "hidden"
                  } `}
                  alt=""
                />
                <img
                  src={studentlogo.src}
                  className={`w-[24px] h-[24px] group-hover/item:hidden ${
                    router.asPath.includes("success-story") ? "hidden" : "block"
                  }`}
                  alt=""
                />
                <p className={`group-hover:block hidden `}>Sucess Story</p>
              </div>
            </Link>
            {/* <Link
              legacyBehavior
