...
const ERBanner2 = ({ Close }) => {
  ...
  return (
    <div className="relative h-screen md:h-auto bg-[#F5F5F5] md:bg-white shadow-lg px-6 pt-12 sm:px-4 md:px-8 rounded-lg md:rounded-xl overflow-hidden w-screen md:w-[80vw] xl:w-[70vw]  mx-auto z-50">
      {/* Close Button */}
      <button
        onClick={Close}
